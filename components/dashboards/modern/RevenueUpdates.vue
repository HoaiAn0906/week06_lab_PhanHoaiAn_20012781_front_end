  ...
  <v-card elevation="10">
    <v-card-text>
      <div class="d-sm-flex align-start">
        <div>
          <h2 class="text-h5">Revenue Updates</h2>
        </div>
        <v-spacer />
        <div class="ml-auto">
          <v-select v-model="select" dense hide-details :items="items" variant="outlined" />
        </div>
      </div>
      <div>
        <apexchart height="300px" :options="Chart" :series="Chart.series" type="line" />
      </div>
