...
<template>
  ...
  <VCard elevation="10">
    ...
    <v-card-text>
      <div>
        <h2 class="text-h5 title mb-1">Our Visitors</h2>
        <h5 class="text-subtitle-1">Different Devices Used to Visit</h5>
      </div>
      <div class="mt-5 pt-5 position-relative">
        <apexchart height="265" :options="chartOptions" :series="chartOptions.series" type="donut" />
      </div>
      <div class="d-flex align-center justify-space-between mt-9">
        <div class="d-flex align-center px-2">
          ...
          <span class="textSecondary text-subtitle mr-1">Tablet</span>
        </div>
        <div class="d-flex align-center px-2">
          <span class="text-overline">
            <i class="mdi mdi-brightness-1 text-primary mx-1" />
          </span>
          <span class="textSecondary text-subtitle mr-1">Mobile</span>
        </div>
        <div class="d-flex align-center px-2">
          <span class="text-overline">
            <i class="mdi mdi-brightness-1 mx-1" />
          </span>
          <span class="textSecondary text-subtitle mr-1">Desktop</span>
        </div>
      </div>
    </v-card-text>
  </VCard>
