...
<template>
  ...
  <v-card elevation="10">
    ...
    <v-card-text>
      <div class="d-sm-flex align-center">
        ...
        <div class="ml-auto">
          <div class="d-flex align-center mt-sm-0 mt-3">
            ...
            <div class="d-flex align-baseline">
              <v-icon color="" size="sm">mdi-circle</v-icon>
              <div class="ml-2">
                <h3 class="text-subtitle-1 font-weight-medium">15,200</h3>
                Sales
              </div>
            </div>
          </div>
      ...
      <div class="mt-5">
        <apexchart height="320px" :options="chartOptions" :series="chartOptions.series" type="area" />
      </div>
    </v-card-text>
  </v-card>
</template>
