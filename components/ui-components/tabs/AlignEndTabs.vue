...
const tab = ref(null)
const tab1 = ref([{ img: img1 }, { img: img2 }, { img: img3 }, { img: img4 }, { img: img5 }, { img: img1 }])
const tab2 = ref([{ img: img6 }, { img: img7 }, { img: img8 }, { img: img9 }, { img: img10 }, { img: img11 }])
const tab3 = ref([{ img: img12 }, { img: img13 }, { img: img14 }, { img: img10 }, { img: img15 }, { img: img11 }])
</script>
<template>
  <v-card elevation="0">
        ...
        <v-window-item value="1">
          <v-row>
            <v-col v-for="item in tab1" :key="item.img" cols="12" md="4" sm="6">
              <v-img alt="tab" class="w-100" cover height="250" :src="item.img" />
            </v-col>
          </v-row>
        </v-window-item>
