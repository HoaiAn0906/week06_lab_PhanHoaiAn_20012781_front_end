  ...
  <v-expansion-panels>
    <v-expansion-panel elevation="10">
      <v-expansion-panel-title>
        <v-row no-gutters>
          <v-col class="d-flex justify-start" cols="12" md="5">
            <h6 class="text-h6">General settings</h6>
          </v-col>
          <v-col class="d-flex justify-start mt-md-0 mt-3" cols="12" md="6">
    ...
    <v-expansion-panel elevation="10">
      <v-expansion-panel-title>
        <v-row no-gutters>
          <v-col class="d-flex justify-start mt-md-0 mt-3" cols="10">
