...
<template>
  <v-card elevation="10">
    <v-card-item>
      ...
      <apexchart class="mt-6" height="275" :options="chartOptions" :series="seriescolumnchart" type="donut" />
      <v-row class="mt-5">
        <v-col cols="6">
          <div class="d-flex align-center mt-md-6 mt-3">
            ...
            <div class="pl-4">
              ...
              <h6 class="text-subtitle-1 textSecondary">Profit</h6>
            </div>
          </div>
        </v-col>
        <v-col class="d-flex justify-lg-start justify-end" cols="6">
          <div class="d-flex align-center mt-md-6 mt-3">
