...
<template>
  <div class="d-flex flex-column gap-1">
    <v-card v-for="[name, cls, val] in headings" :key="name" class="my-3 pa-6" variant="outlined">
  ...
  <div class="d-flex flex-column gap-1">
    <v-card v-for="[name1, cls1, val1, prop] in subtext" :key="name1" class="my-3 pa-6" variant="outlined">
      <div :class="[cls1, '']">
        {{ name1 }}
        <span>{{ val1 }}</span>
      </div>
